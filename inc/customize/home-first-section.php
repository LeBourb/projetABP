...
function mytheme_customize_register( $wp_customize ) {
   //All our sections, settings, and controls will be added here
    $wp_customize->add_section( 'home_content' , array(
				'title'      			=> __( 'Home Content', 'storefront' ),
				'priority'   			=> 45,
    ) );
    ...
    $wp_customize->add_control( new WP_Customize_Media_Control( $wp_customize, 'link_media_video', array(
	'label'      => __( 'Video', 'atelierbourgeons' ),
