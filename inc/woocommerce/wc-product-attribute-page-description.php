...
/**
 * Description of wc-product-attribute-page_description
 *
 * @author smash
 */

class Product_Attribute_Page_Description {
  ...
  // Constructor
    ...
    public function init() {
        ...
        $ajax_events = array(
            'select_page_description'                                    => false,
            //'add_new_advanced_attribute'                                => false,
            'save_selected_page_description'                                  => false
        );
...
<?php
    ...
    */
    function select_page_description() {
           ob_start();
           ...
           $page_description_id = $_POST['page_description_id'];
           include( 'views/html-product-page-description-admin-link.php' );
           wp_die();
    }
...
/*                        if ( is_array( $options ) ) {
    ...
    */
    function save_selected_page_description() {
           ...
           update_post_meta( $_POST['post_id'], 'product_page_description_id', $page_description_id );
    ...
    */
    function add_tab() {
            echo '<li class="page_description_tab"><a href="#page_description_tab">' . __( 'Page Description', 'wcgmcf' ) . '</a></li>';
    }
    /**
    * Tab content.
    */
    function tab_view() {
           $is_tabvisible = 1;
           include('views/html-product-page-description.php');           
    }
    
}
new Product_Attribute_Page_Description();
