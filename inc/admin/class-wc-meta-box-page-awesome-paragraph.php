...
/**
 * WC_Meta_Box_Page_Awesome_Paragraph Class.
 */
class WC_Meta_Box_Page_Awesome_Paragraph {
    ...
    public static function output($post) {
        ?><div id="wc_awesome_meta">
            <?php
            include 'view/html-page-awesome-paragraph.php';
            echo '</div>';
            ...
            <script>
                jQuery(function ($) {
                    ...
                    $('button.add_awesome_description').on('click', function () {
                        ...
                        var $wrapper = $('#wc_awesome_tab');
                        var $attributes = $wrapper.find('.product_awesome_descriptions');
                        var product_type = $('select#product-type').val();
                        var data = {
                            action: 'woocommerce_add_awesome_paragraph',
                            taxonomy: attribute,
                            i: size,
