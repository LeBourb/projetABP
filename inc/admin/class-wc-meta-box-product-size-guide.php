 ...
 */
class WC_Meta_Box_Product_Size_Guide {
	...
	public static function output( $post ) {
            ...
            $size_guide = get_post_meta(  $post->ID, 'wc_size_guide', true);  
            echo '<div id="wc_size_guide_container">';

                include 'view/html-product-size-guide.php';
                echo '</div>';
